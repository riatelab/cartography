---
title: '***Commented Scripts to Build Maps with `cartography`*** '
...
```{r labelMap, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
...
```{r choroMap, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
...
# Base Map and Proportionnal Symbols

```{r propMap, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
...
```{r linkMap, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
...
```{r propchoroLayer, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
...
```{r discLayer, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
...
```{r gridLayer, fig.height=5, fig.width=7}
library(cartography)
# Load data
data(nuts2006)
# set margins
