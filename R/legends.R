...
LegendCircSymbols<- function(pos = "topleft", legTitle = "Title of the legend", 
                             legTitleCex = 0.8,
                             legValuesCex = 0.6, varvect, sizevect, breakval, col1="red", 
                             col2="blue", frame=FALSE, round=0, type ="c"){
  varvect <- abs(varvect)
...
LegendSquaresSymbols<- function(pos = "topleft", legTitle = "Title of the legend", 
                                legTitleCex = 0.8,
                                legValuesCex = 0.6, varvect, sizevect, breakval, 
                                col1="red", col2="blue", frame=FALSE, round=0, type ="c"){
...
LegendHeightSymbols<- function(pos = "topleft", legTitle = "Title of the legend", 
                               legTitleCex = 0.8,
                               legValuesCex = 0.6, varvect, sizevect, breakval, 
                               col1="red", col2="blue", frame=FALSE, round=0, type ="c"){
