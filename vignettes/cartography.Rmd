...
`propSymbolsLayer()` displays symbols proportional to a quantitative variable (stocks). Several symbols are available (circles, squares, bars). The `inches` argument is used to customize the symbols sizes. 
...
## Colored Pencil Maps and Typologies
