...
```{r propchoro, fig.height=6, fig.width=5, margin=TRUE}
library(sf)
library(cartography)
# path to the geopackage file embedded in cartography
path_to_gpkg <- system.file("gpkg/mtq.gpkg", package="cartography")
...
```{r proptypo, fig.height=6, fig.width=5, margin=TRUE}
library(sf)
library(cartography)
# path to the geopackage file embedded in cartography
path_to_gpkg <- system.file("gpkg/mtq.gpkg", package="cartography")
...
```{r linkMap, fig.height=6, fig.width=5, margin=TRUE}
library(sf)
library(cartography)
# path to the geopackage file embedded in cartography
path_to_gpkg <- system.file("gpkg/mtq.gpkg", package="cartography")
...
`smoothLayer()` heavily depends on the [`SpatialPosition`](ttps://CRAN.R-project.org/package=SpatialPosition) package. The function uses a marked point layer and a set of parameters (a spatial interaction function and its parameters) and displays an isopleth map layer.
